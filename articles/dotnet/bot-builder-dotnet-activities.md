...
description: .NET용 Bot Framework SDK 내에서 사용할 수 있는 다양한 활동 유형에 대해 알아봅니다.
author: RobStand
ms.author: kamrani
manager: kamrani
ms.topic: article
...
## <a name="activity-types-in-the-bot-framework-sdk-for-net"></a>.NET용 Bot Framework SDK의 활동 유형

.NET용 Bot Framework SDK에서 다음 활동 유형이 지원됩니다.
