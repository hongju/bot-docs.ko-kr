...
- 이 문서의 코드는 **LUIS를 통한 NLP** 샘플을 기반으로 합니다. [C# 샘플](https://aka.ms/cs-luis-sample) 또는 [JS 샘플](https://aka.ms/js-luis-sample)의 복사본이 필요합니다. 
...
프로젝트에 **Microsoft.Bot.Builder.AI.Luis**라는 nuget 패키지가 설치되어 있는지 확인하세요.
