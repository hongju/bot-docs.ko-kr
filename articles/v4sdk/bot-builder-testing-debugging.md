...
또한 사용자 입력 상호 작용이 저장되면 Azure의 "_저장소 탐색기_"를 사용하여 Blob 기록 저장소 내에 저장된 기록에 포함된 데이터를 수동으로 확인할 수 있습니다. 다음 예제에서는 "_mynewtestblobstorage_"에 대한 설정에서 "_스토리지 탐색기_"를 엽니다. 저장된 사용자 입력을 열려면 Blob 컨테이너 > ChannelId > TranscriptId > ConversationId를 선택합니다.
