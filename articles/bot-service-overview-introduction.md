...
## <a name="plan"></a>계획 
코드를 작성하기 전에 모범 사례에 대한 봇 [디자인 지침](bot-service-design-principles.md) 을 검토하고 봇에 필요한 요구 사항을 확인합니다. 간단한 봇을 만들거나 음성, 언어 이해, QnA 또는 다양한 출처에서 정보를 추출하여 지능형 응답을 제공하는 기능 등 더 복잡한 기능을 포함시킬 수 있습니다. [CLI 도구](~/bot-builder-create-templates.md), [Azure Portal](bot-service-quickstart.md) 또는 아래 템플릿을 사용하여 시작할 수 있습니다.
...
- 봇 자산을 만들고 관리하는 [CLI 도구](https://github.com/Microsoft/botbuilder-tools)를 다운로드합니다. 이러한 도구는 명령줄에서 봇 구성 파일, LUIS 앱, QnA 기술 자료 등을 관리하는 데 유용합니다. 자세한 내용은 [추가 정보](https://github.com/Microsoft/botbuilder-tools/blob/master/README.md)에서 볼 수 있습니다.
- 봇을 테스트하기 위한 [에뮬레이터](https://github.com/Microsoft/BotFramework-Emulator/releases)
- 자연어를 봇에 추가하기 위한 [LUIS](https://www.luis.ai/)
- 더 자연스러운 대화형 방식으로 사용자의 질문에 응답하기 위한 [QnA Maker](https://qnamaker.ai/)
...
사용 가능한 많은 구성 요소 중 일부는 다음과 같습니다.

| 구성 요소 | 설명 |
| --- | --- |
| [LUIS](https://docs.microsoft.com/en-us/azure/cognitive-services/luis/home) | 언어 이해 추가 |
| [QnA Maker](https://docs.microsoft.com/en-us/azure/cognitive-services/qnamaker/home)  | 사용자 질문에 대답하기 위해 기술 자료를 추가합니다. |
| [Dispatch 도구](~/v4sdk/bot-builder-tutorial-dispatch.md) | 둘 이상의 모델을 사용하는 경우 지능적으로 어느 것을 어느 때에 사용할지 결정합니다. |
| [다양한 미디어](v4sdk/bot-builder-howto-add-media-attachments.md) | 미디어 카드 또는 음성을 사용하여 사용자 환경을 개선합니다. |
| [음성](https://azure.microsoft.com/services/cognitive-services/speech/) | 오디오를 텍스트로 변환하고, 의도를 이해하고, 텍스트를 다시 음성으로 변환합니다. |
| [맞춤법 검사](https://azure.microsoft.com/services/cognitive-services/spell-check/) | 맞춤법 오류를 수정하고, 이름, 브랜드 이름 및 은어 간 차이점을 인식합니다. |
...
## <a name="publish"></a>게시 
준비되면 봇을 Azure 또는 사용자 고유의 웹 서비스 또는 데이터 센터에 게시합니다. 봇을 로컬로 개발할 수 있도록 지속적인 배포를 설정할 수 있습니다. 이는 봇이 GitHub 또는 Visual Studio Team Services와 같은 소스 제어에 체크 인하는 경우에 유용합니다. 변경 내용을 소스 리포지토리로 다시 확인하는 대로 변경 내용이 자동으로 Azure에 배포됩니다.

지속적인 배포를 통해 [Azure에 배포](bot-service-build-continuous-deployment.md)합니다.
